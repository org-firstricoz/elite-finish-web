...
const HeroCard: React.FC = () => {
    return (
        <div className="absolute bottom-40 md:left-24  left-4 right-4 md:right-0 h-[6rem] lg:w-[57rem]  md:w-[40rem]   w-contain lg:px-12 sm:px-4 px-3 border-2  bg-white flex items-center  rounded-lg shadow-lg gap-4 ">
