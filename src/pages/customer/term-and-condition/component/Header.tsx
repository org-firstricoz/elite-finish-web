...
const Header:React.FC<Props> = ({mainHeading, subHeading}) => {
    ...
    return (
        <div className="flex ">
            <div className="bg-elite-red md:w-7/12 w-9/12 rounded-l-2xl p-4 px-12 border-r-transparent">
            {
                subHeading &&   
                <h1 className="md:text-md text-xs text-white/75 font-thin">{subHeading}</h1>
            }
                <h1 className="md:text-3xl sm:text-lg text-white font-semibold sm:pt-2">{mainHeading}</h1>
            </div>
